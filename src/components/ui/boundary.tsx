...
const Label = ({ children, animateRerendering, color }: Props) => {
    return (
        <div className={clsx('rounded-full px-1.5 shadow-[0_0_1px_1px_gray]', {
...
export const Boundary = ({ children, labels = ['children'], size = 'default', color = 'default', animateRerendering = true}: BoundaryProps) => {
