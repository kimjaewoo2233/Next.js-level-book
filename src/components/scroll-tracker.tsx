...
import { useAtBottom } from "@/\bhooks/use-at-bottom"
import { useCopyToClipboard } from "@/\bhooks/use-copy-to-clipboard";
...
function Content() {
    ...
    return (
        <div className="p-4 text-center text-gray-700l border border-gray-300 rounded-lg">
            <p>{textToCopy}</p>
