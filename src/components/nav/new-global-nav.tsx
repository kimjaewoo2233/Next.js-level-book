...
export function GlobalNav() {
    ...
    return (
        <div className="fixed top-0 z-10 flex flex-col w-full bg-white border-b border-gray-800 lg:bottom-0
                        lg:z-auto lg:w-72 lg:border-b-0 lg:border-r lg-border-gray-800
        ">
